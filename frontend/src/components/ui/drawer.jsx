...
const DrawerHeader = ({
  ...
  <div
    className={mergeClassnames("grid gap-1.5 p-4 text-center sm:text-left", className)}
    {...props} />
)
...
const DrawerFooter = ({
  ...
  <div className={mergeClassnames("mt-auto flex flex-col gap-2 p-4", className)} {...props} />
)
